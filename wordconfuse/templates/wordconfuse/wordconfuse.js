 ...
 */
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                jQuery.each(game.wl, function(index,value) {
                    ...
                    objImage.src =
                        '{{STATIC_PREFIX}}wordconfuse/img/words/'+value['q']+'.png';
    ...
    answer_click: function () {
        ...
        if (id == 'a' + game.wd['s']) {
            ...
            $('.nt').css({
                'backgroundImage':
                    'url("{{STATIC_PREFIX}}wordconfuse/img/goodjob.png")',
            });
            ...
            $('.nt').css({
                'backgroundImage':
                    'url("{{STATIC_PREFIX}}wordconfuse/img/wronganswer.png")',
            });
            $('.nt').fadeIn('slow',function() {
                setTimeout(game.show_answer, 300);
            });
            ...
            $('.game-questions').fadeOut( 'slow',  function() {
                ...
                game.s = setInterval( function() {
                    if (game.sec_left <= 1) {
                        ...
                        $('.nt').css({
                            'backgroundImage':
                                'url("{{STATIC_PREFIX}}wordconfuse/img/outoftime.png")',
                        });
                        $('.nt').fadeIn('slow',function() {
                            game.show_answer();
                        });
                ...
                $('.qb').html('<img src="{{STATIC_PREFIX}}wordconfuse/img/words/' + game.wd['q'] + '.png" />');
