...
var PointerTool = {
    name: "Pointer",
    image: STATIC_URL + "yelpvis/images/cursor.png",
    select: function () {
...
var RectangleTool = {
    name: "Rect",
    image: STATIC_URL + "yelpvis/images/Rectangle.png",
    start: 0,
    bbox: null,
    panel1: null,
    panel2: null,
...
//alert(this.x)
        ...
        RectangleTool.drawspace.on("mouseup", function () {
            ...
            Toolbox.select("Rectangle", [
                [(box[0] - Panel.x), (box[1] - Panel.y)],
                [(box[0] - Panel.x), (box[1] - Panel.y) + box[3]],
                [(box[0] - Panel.x) + box[2], (box[1] - Panel.y) + box[3]],
                [(box[0] - Panel.x) + box[2], (box[1] - Panel.y)]
            ], Toolbox.inclusive);
...
var EllipseTool = {
    name: "Ellipse",
    image: STATIC_URL + "yelpvis/images/Ellipse.png",
    start: 0,
    bellipse: null,
    panel1: null,
    panel2: null,
...
var LassoTool = {
    name: "Lasso",
    image: STATIC_URL + "yelpvis/images/Lasso.png",
    start: 0,
    segments: 0,
    dragging: 0,
    points: [],
...
var Straight = {
    name: "Straight",
    image: STATIC_URL + "yelpvis/images/straight_line.png",
    start: 0,
    Line: null,
    panel1: null,
    panel2: null,
...
var Polyline = {
    name: "Polyline",
    image: STATIC_URL + "yelpvis/images/PolyLine.png",
    start: 0,
    before: 0,
    segments: 0,
    dragging: 0,
...
var Freeselect = {
    name: "Freeselect",
    image: STATIC_URL + "yelpvis/images/free_select.png",
    start: 0,
    segments: 0,
    dragging: 0,
    points: [],
...
var PolygonTool = {
    name: "Polygon",
    image: STATIC_URL + "yelpvis/images/polygon.png",
    start: 0,
    before: 0,
    segments: 0,
    dragging: 0,
...
var PanZoomTool = {
    name: "PanZoom",
    image: STATIC_URL + "yelpvis/images/Pan.png",
    start: null,
    panel1: null,
    panel2: null,
    zoomUserScale: 1,
...
var RotateTool = {
    name: "Rotate",
    image: STATIC_URL + "yelpvis/images/rotate.png",
    start: null,
...
var AnnotatedByPointTool = {
    name: "AbyPoint",
    image: STATIC_URL + "yelpvis/images/AnP.png",
    start: null,
    end: [],
    isDrag: false,
    isResize: false,
...
var AnnotatedByAreaTool = {
    name: "AbyArea",
    image: STATIC_URL + "yelpvis/images/AnA.png",
    start: 0,
    segments: 0,
    dragging: 0,
    points: [],
    ...
    init: function (svg, width, height) {
        ...
        for (var i = 0; i < this.tools.length; i++) {
            ...
            var checked = checkbox.append("svg:image")
                ...
                .attr("width", 15)
                .attr("height", 15)
                .attr("xlink:href", STATIC_URL + "yelpvis/images/checkbox_yes.png")
                .on("click", function () {
                    if (Toolbox.inclusive == true) {
                        Toolbox.inclusive = false;//alert("0")
                        checked.attr("xlink:href", STATIC_URL + "yelpvis/images/checkbox_no.png")
                        //checked.setAttributeNS(null,"xlink:href", "images/checkbox_no.png")
                    }
                    else {
                        Toolbox.inclusive = true;//alert("1")
                        checked.attr("xlink:href", STATIC_URL + "yelpvis/images/checkbox_yes.png")
...
//alert("JFKDSLSDDSF")
        ...
        trashtool.append("svg:image")
            ...
            .attr("width", 20)
            .attr("height", 20)
            .attr("xlink:href", STATIC_URL + "yelpvis/images/Delete.png")
            .on("mousedown", function () {
                //QueryManager.trashtoggle=1;
                //QueryManager.uniontoggle=0;
                //QueryManager.commontoggle=0;
...
//alert(QueryManager.querybox[num-1])
        ...
        uniontool.append("svg:image")
            ...
            .attr("width", 24)
            .attr("height", 24)
            .attr("xlink:href", STATIC_URL + "yelpvis/images/or.png")
            .on("mousedown", function () {//alert(QueryManager.querytoggle)
...
//	    .attr("x",queryWidth/2+this.margin).attr("y",this.margin)
        ...
        commontool.append("svg:image")
            ...
            .attr("width", 24)
            .attr("height", 24)
            .attr("xlink:href", STATIC_URL + "yelpvis/images/and.png")
            .on("mousedown", function () {//alert(QueryManager.querytoggle)
                //QueryManager.trashtoggle=0;
                //QueryManager.uniontoggle=1;
                //QueryManager.commontoggle=0;
...
//	    .attr("x",3*queryWidth/4+this.margin).attr("y",this.margin)
        ...
        xortool.append("svg:image")
            ...
            .attr("width", 24)
            .attr("height", 24)
            .attr("xlink:href", STATIC_URL + "yelpvis/images/xor.png")
            .on("mousedown", function () {//alert(QueryManager.querytoggle)
                //QueryManager.trashtoggle=0;
                //QueryManager.uniontoggle=1;
                //QueryManager.commontoggle=0;
                ...
                for (var i = 0; i < 6; i++) {
                    for (var j = 0; j < 6; j++) {//alert(colorbox)
                        ...
                        var cbox = colorbox.append("rect")
                            ...
                            .on("click", function () {
                                var str = this.getAttributeNS(null, "id");//alert(newcolor)
