...
class TwitterUserProvider(ActivityProvider):
    ...
    def get_activity(self):
        ...
        api = TwitterLibrary.Api(consumer_key = 'AtDvumv2XT7iAbzsPEInQ', 
                consumer_secret='z5atyQUwygHxSuSlBGTUMgflzudWzYBkSalPLx5FF4U'
                ,access_token_key = '38975687-rBGM5Wj23VNdYz8n8Gg8zMqgOBKfZ4uHaZ5uCH8MD'
                ,access_token_secret = 'qpPMWwzMgWt2kYocyLM6nI3NUEcyWK2FHw8MlT8j90')
