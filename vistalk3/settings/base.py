...
STATIC_ROOT = '/var/www/sociavis.com/static'
...
SECRET_KEY = '9b5&^x)driak8pg10q7bl=)*62y_ynca1w@0^kimm1#zt7yyec'
...
ROOT_URLCONF = 'vistalk3.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'vistalk3.wsgi.application'
