...
$('#page1').live('pageinit', function () {
    ...
    function updateLegend(space, selectionState) {
        ...
        if (space === 'movie') {
            ...
            myImage = STATIC_URL + "movievis/images/left_arrow_bg.svg";

        } else if (space === 'user') {

            myImage = STATIC_URL + "movievis/images/right_arrow_bg.svg";
        ...
        var myLegendRect = svgLegend.selectAll("rect")
            .data(selectionState.querySetsList, function (d) {
                return d.legend;
            });
...
// 
    ...
    function writeDownloadLink() {
        var myEvent = {data:[{"a":1, "b":2},{"a":2, "b":2}]};
        $.ajax({
            url: "save_json",
            type: 'POST',
